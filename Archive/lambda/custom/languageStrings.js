...
module.exports = {
    en: {
        translation: {
            WELCOME_MSG: 'Welcome to Sixty Second Workout! How long do you want your workout to be?',
            GET_STARTED_MSG: "OK, Let's begin a {{howLong}} minute workout!",
            WORKOUT_MSG: 'Here we go, do {{workout}} for sixty seconds...',
            HELP_MSG: 'For example, if you want a 5 minute workout, say 5, or say 30 for a 30 minute workout.',
            GOODBYE_MSG: 'Goodbye! Thanks for using Sixty Second Workout!',
