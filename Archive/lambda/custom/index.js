...
const HowLongIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'HowLongIntent';
    },
    handle(handlerInput) {
        let intent = handlerInput.requestEnvelope.request.intent;
        const howLong = intent.slots.howLong.value;
        const speakOutput = handlerInput.t('GET_STARTED_MSG', {howLong: howLong});
